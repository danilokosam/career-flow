...
export type TokenWhereInput = {
  ...
  clerkId?: Prisma.StringFilter<"Token"> | string
  tokens?: Prisma.IntFilter<"Token"> | number
}
...
export type TokenScalarWhereWithAggregatesInput = {
  ...
  clerkId?: Prisma.StringWithAggregatesFilter<"Token"> | string
  tokens?: Prisma.IntWithAggregatesFilter<"Token"> | number
}
...
export type TokenOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"clerkId" | "tokens", ExtArgs["result"]["token"]>
...
export interface TokenDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const tokenWithClerkIdOnly = await prisma.token.findMany({ select: { clerkId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Tokens and only return the `clerkId`
   * const tokenWithClerkIdOnly = await prisma.token.createManyAndReturn({
   *   select: { clerkId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Tokens and only return the `clerkId`
   * const tokenWithClerkIdOnly = await prisma.token.updateManyAndReturn({
   *   select: { clerkId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface TokenFieldRefs {
  readonly clerkId: Prisma.FieldRef<"Token", 'String'>
  readonly tokens: Prisma.FieldRef<"Token", 'Int'>
}
